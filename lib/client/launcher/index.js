  ...
  */
  ...
  BrowserLauncher = (function() {
      ...
      if (config.plugin) {
        for (transportType in config.plugin) {
          ...
          for (name in transportPluginConfig) {
            cfg = {};
            cfg[transportType] = (_ref = BrowserLauncher.plugins[name]) != null ? _ref.client(transportPluginConfig[name]) : void 0;
            this.use(cfg);
          }
        }
      }
    ...
    */
    ...
    BrowserLauncher.prototype.getBrowser = function(options, callback) {
      var ops;

      ops = this._fixOptions(options);
      return this.test(options, function(err, launcher) {
        if (!launcher) {
          return callback(err);
        }
        return launcher.test(ops, callback);
      });
    };
    ...
    */
    ...
    BrowserLauncher.prototype.start = function(options, callback) {
      ...
      return this.test(ops, function(err, launcher) {
        ...
        return launcher.start(ops, callback);
      });
    };
