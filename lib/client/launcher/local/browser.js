...
(function() {
  var Browser, EventEmitter, Version, async, asyngleton, cstep, dirmr, exec, fiddle, fs, os, outcome, path, rmdir, sift, utils, _,
  ...
  Browser = (function(_super) {
    ...
    */
    ...
    function Browser(directory, config, versions) {
      ...
      this._systemSettingPaths = [];
      if (this.config.settings) {
        for (name in this.config.settings) {
          this._systemSettingPaths.push(this.config.settings[name]);
        }
      }
    }
      ...
      return this.killAll(function() {
        return _this.test(options, function(err, version) {
          ...
          return _this._copySettingsToSys(function() {
            ...
            _this._process.on("exit", _this._onExit);
    ...
    */
    ...
    Browser.prototype.cleanup = cstep(function(callback) {
      return async.forEach(this._systemSettingPaths, (function(settingPath, next) {
        if (!fs.existsSync(settingPath)) {
          return next();
        }
        utils.logger.log("rm -rf " + settingPath);
        return rmdir(settingPath, next);
      }), callback);
    });
